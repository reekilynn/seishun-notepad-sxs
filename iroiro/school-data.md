...
* 私立天道大学附属学校（学校名称缩写为UTAS）位于天道市轨道交通4号线（原称天道大学线）的倒数第二站。
...
* 主教学楼（总计7层，1层通向地面，2层为与天桥相连的大厅，B-K分楼均有直通-1层地下车库的电梯）
    * 图书馆（A，自1层起，共3层）
    * 高等部学生教室（B、D、F，3-6层）
    * 中等部学生教室（C、E、G，3-6层）
    * 高等部实验室及社团活动室（H/J，1-6层）
    * 中等部实验室及社团活动室（I/K，1-6层）
    * 教职工办公室（位于上述楼层的连接位置）
    * 小卖部、书店、文具店、自动贩卖机（位于2层大厅）
    * 小食堂（L，位于与图书馆相对的另一端，仅有1层）
...
中等部的体育着及ジャージ的配色为绿色/白色，而高等部则为红色/白色。
